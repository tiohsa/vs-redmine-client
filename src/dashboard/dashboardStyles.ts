...
#header-label{font-size:10px;font-weight:600;letter-spacing:.08em;text-transform:uppercase;color:var(--app-text-readable-muted);margin-bottom:6px;line-height:1.4}
#header-row{display:flex;align-items:center;gap:6px;flex-wrap:wrap}
.project-select{flex:1;min-width:0;height:32px;padding:0 8px;background:var(--vscode-dropdown-background, var(--surface-1));color:var(--vscode-dropdown-foreground, var(--app-text));border:1px solid var(--vscode-input-border, var(--app-card-border));border-radius:var(--mm-radius-button);font:inherit;font-size:12px;cursor:pointer;max-width:180px}
...
.btn-icon{width:32px;height:32px;display:flex;align-items:center;justify-content:center;border:none;background:transparent;color:var(--app-text-readable-muted);border-radius:var(--mm-radius-button);cursor:pointer;font-size:15px;flex-shrink:0;transition:background .15s,color .15s}
...
.tab{height:28px;padding:0 12px;border-radius:var(--mm-radius-pill);font-size:12px;font-weight:500;color:var(--app-text-readable-muted);cursor:pointer;background:var(--surface-1);border:1px solid var(--border-subtle);white-space:nowrap;user-select:none;transition:background .15s,color .15s,border-color .15s;display:flex;align-items:center;gap:5px}
...
.tab-badge{min-width:16px;height:16px;padding:0 4px;border-radius:var(--mm-radius-pill);background:var(--app-badge-bg);color:var(--app-badge-fg);font-size:10px;font-weight:600;display:flex;align-items:center;justify-content:center}
...
.ticket-row{position:relative;display:flex;align-items:center;gap:6px;padding:8px 10px 8px 12px;min-height:40px;cursor:pointer;border-bottom:1px solid var(--border-subtle);transition:background .1s}
...
/* ID badge */
.ticket-id{font-size:10.5px;white-space:nowrap;flex-shrink:0;font-weight:600;padding:2px 8px;min-width:42px;text-align:center;border-radius:var(--mm-radius-pill);background:color-mix(in srgb, var(--app-badge-bg) 22%, var(--surface-2));color:var(--app-text);border:1px solid var(--border-subtle);font-variant-numeric:tabular-nums}
...
.ticket-subject{flex:1;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;font-size:12.5px;min-width:40px;color:var(--app-text)}
.badges{display:flex;gap:3px;flex-shrink:1;flex-wrap:wrap;justify-content:flex-end;min-width:0}

/* Sync / priority badges */
.badge{padding:2px 7px;border-radius:var(--mm-radius-pill);font-size:10.5px;font-weight:500;white-space:nowrap;background:var(--surface-1);color:var(--app-text-readable-muted);border:1px solid var(--border-subtle)}
...
.detail-actions .btn{padding:5px 6px;min-width:0;font-size:12px}
...
.detail-select,.detail-input{min-width:0;width:100%;background:var(--vscode-input-background, var(--surface-1));color:var(--vscode-input-foreground, var(--app-text));border:1px solid var(--vscode-input-border, var(--app-card-border));border-radius:var(--mm-radius-button);font:inherit;font-size:12px;padding:3px 7px}
...
.ticket-action-menu button{width:100%;border:none;background:transparent;color:var(--app-text);border-radius:var(--mm-radius-button);padding:6px 10px;text-align:left;font:inherit;font-size:11.5px;cursor:pointer;line-height:1.4}
...
/* ── Buttons ──────────────────────────────────────────────────── */
.btn{padding:5px 12px;border-radius:var(--mm-radius-button);font-size:12px;font-weight:600;cursor:pointer;border:none;transition:background .15s;line-height:1.5}
...
#sync-all-btn{width:100%;height:36px;margin-bottom:8px;background:var(--app-accent);color:var(--app-accent-fg);border:none;border-radius:var(--mm-radius-button);font:inherit;font-size:12.5px;font-weight:600;cursor:pointer;transition:background .15s}
...
.setting-row{display:flex;align-items:center;justify-content:space-between;padding:6px 0;border-bottom:1px solid var(--border-subtle);font-size:12.5px;gap:8px}
.setting-label{color:var(--app-text);font-weight:500}
.setting-value{color:var(--app-text-readable-muted);font-size:11.5px}
.setting-input,.setting-select{background:var(--vscode-input-background, var(--surface-1));color:var(--vscode-input-foreground, var(--app-text));border:1px solid var(--vscode-input-border, var(--app-card-border));border-radius:var(--mm-radius-button);font:inherit;font-size:12px;padding:3px 7px}
...
.unsynced-kind-label{font-size:10.5px;font-weight:600;padding:2px 6px;border-radius:var(--mm-radius-pill);background:var(--surface-1);color:var(--app-text-readable-muted);border:1px solid var(--app-card-border);white-space:nowrap;flex-shrink:0}
...
.toast{padding:8px 12px;border-radius:var(--mm-radius-button);font-size:12px;font-weight:500;background:var(--surface-1);color:var(--app-text);border:1px solid var(--app-card-border);border-left-width:3px;box-shadow:0 4px 16px rgba(0,0,0,0.2);pointer-events:auto;opacity:1;transition:opacity .6s ease}
