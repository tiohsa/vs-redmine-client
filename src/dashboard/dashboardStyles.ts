...
.toggle-children{display:flex;align-items:center;gap:4px;font-size:11.5px;color:var(--app-text-secondary);cursor:pointer;user-select:none;white-space:nowrap}
.toggle-children input{accent-color:var(--app-accent)}
.btn-icon{width:26px;height:26px;display:flex;align-items:center;justify-content:center;border:none;background:transparent;color:var(--app-text-secondary);border-radius:var(--mm-radius-button);cursor:pointer;font-size:15px;flex-shrink:0;transition:background .15s}
...
.tab{padding:6px 12px;border-radius:var(--mm-radius-pill);font-size:12px;font-weight:500;color:var(--app-text-secondary);cursor:pointer;border:1px solid transparent;white-space:nowrap;user-select:none;transition:background .15s,color .15s;display:flex;align-items:center;gap:5px}
...
.ticket-id{font-size:11px;color:var(--app-text-muted);white-space:nowrap;flex-shrink:0;min-width:38px}
...
.badge{padding:2px 7px;border-radius:var(--mm-radius-pill);font-size:10.5px;font-weight:500;white-space:nowrap;background:var(--app-surface-subtle);color:var(--app-text-secondary);border:1px solid var(--app-card-border)}
...
.btn-secondary{background:transparent;color:var(--app-text-secondary);border:1px solid var(--app-card-border)}
...
.settings-section h3{font-size:11.5px;font-weight:600;color:var(--app-text-muted);text-transform:uppercase;letter-spacing:.06em;margin-bottom:8px}
...
.state-msg{padding:24px 16px;text-align:center;color:var(--app-text-muted);font-size:12.5px;line-height:1.6}
...
.unsynced-kind-label{font-size:10.5px;font-weight:600;padding:2px 6px;border-radius:var(--mm-radius-pill);background:var(--app-surface-subtle);color:var(--app-text-secondary);border:1px solid var(--app-card-border);white-space:nowrap;flex-shrink:0}

.comments-header{display:flex;justify-content:space-between;align-items:center;margin-bottom:10px}
.comments-header-label{font-size:12px;font-weight:600;color:var(--app-text-secondary)}
