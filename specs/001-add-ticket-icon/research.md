...
- **Decision**: Reuse the existing new ticket creation flow and permission model.
...
- **Decision**: Keep changes scoped to the ticket list header UI and related command/activation logic.
